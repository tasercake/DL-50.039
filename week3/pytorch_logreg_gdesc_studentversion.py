...
def run():
    ...
    # Tensordataset
    # TODO
    dtr = None  # TensorDataset from tensors from xtr, ytr - our training features and labels
    dv = None  # TensorDataset from tensors from xv, yv - our validation features and labels
    ...
    # model and loss
    # TODO
    model = None  # your logreglayer properly initialized
    # TODO
    criterion = None  # which loss function suits here, given that our model produces 1-dimensional output  and we want to use it for classification?
    ...
    # TODO
    dte = (
        None  # TensorDataset from tensors from xte, yte - our test features and labels
    )
